...
!COMPILED && goog.DEPENDENCIES_ENABLED && (goog.inHtmlDocument_ = function () {
        ...
        function c() {
            ...
            if (e.contents_) {
                ...
                f && goog.global.$jscomp.require.ensure([e.getPathName()], function () {
                    a.registerEs6ModuleExports(e.path,
                        goog.global.$jscomp.require(e.getPathName()), d)
                });
                a.loaded()
            }
        }
            ...
            if (h || g) a.defer(function () {
                ...
                if (f && goog.inHtmlDocument_() && goog.isDocumentLoading_() && !h) {
                    ...
                    k.onreadystatechange = function () {
                        ...
                        goog.isFunction(l) && l.apply(void 0,
                            arguments)
                    }
    ...
    }, goog.GoogModuleDependency = function (a,
        b, c, d, e, f, g) {
        goog.TransformedDependency.call(this, a, b, c, d, e);
...
goog.html.SafeUrl.isSmsUrlBodyValid_ = function (a) {
    var b = a.match(/[?&]body=/gi);
    if (!b) return !0;
    if (1 < b.length) return !1;
    a = a.match(/[?&]body=([^&]+)/)[1];
    if (!a) return !0;
    try {
        return goog.string.urlEncode(a) === a || goog.string.urlDecode(a) !== a
    } catch (c) {
        return !1
    }
};
...
Blockly.Events.CommentCreate.prototype.run = function (a) {
    Blockly.Events.CommentCreateDeleteHelper(a)
};
Blockly.Events.CommentCreateDeleteHelper = function (a) {
    var b = this.getEventWorkspace_();
...
Blockly.Block.prototype.getOnlyValueConnection_ = function () {
    for (var a = !1, b = 0; b < this.inputList.length; b++) {
...
Blockly.onKeyDown_ = function (a) {
    if (!(Blockly.mainWorkspace.options.readOnly || Blockly.utils.isTargetInput(a) || Blockly.mainWorkspace.rendered && !Blockly.mainWorkspace.isVisible())) {
        var b = !1;
        if (27 == a.keyCode) Blockly.hideChaff();
            ...
            Blockly.selected && Blockly.selected.isDeletable() &&
                Blockly.selected.isMovable() && (67 == a.keyCode ? (Blockly.hideChaff(), Blockly.copy_(Blockly.selected)) : 88 != a.keyCode || Blockly.selected.workspace.isFlyout || (Blockly.copy_(Blockly.selected), b = !0));
        ...
        b && !Blockly.selected.workspace.isFlyout && (Blockly.Events.setGroup(!0),
