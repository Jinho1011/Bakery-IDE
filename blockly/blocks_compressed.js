...
Blockly.defineBlocksWithJsonArray([{
  ...
  type: "colour_rgb",
  message0: "%{BKY_COLOUR_RGB_TITLE} %{BKY_COLOUR_RGB_RED} %1 %{BKY_COLOUR_RGB_GREEN} %2 %{BK" +
        "Y_COLOUR_RGB_BLUE} %3",
  args0: [{
    type: "input_value",
    name: "RED",
  ...
  type: "colour_blend",
  message0: "%{BKY_COLOUR_BLEND_TITLE} %{BKY_COLOUR_BLEND_COLOUR1} %1 %{BKY_COLOUR_BLEND_COLO" +
        "UR2} %2 %{BKY_COLOUR_BLEND_RATIO} %3",
  args0: [{
    type: "input_value",
    name: "COLOUR1",
    check: "Colour",
...
Blockly.Blocks.lists_getIndex = {
    ...
    this.setTooltip(function() {
      ...
      if ("FROM_START" == e || "FROM_END" == e)
        {d += "  " + ("FROM_START" == e ?
                    ...
                    Blockly.Msg.LISTS_INDEX_FROM_END_TOOLTIP).replace("%1", b.workspace.options.oneBasedIndex ?
                    "#1" :
                    "#0");}
      return d;
    });
  ...
  updateStatement_: function(a) {
    a != !this.outputConnection && (this.unplug(!0, !0), a ?
  ...
  updateAt_: function(a) {
    ...
    this.removeInput("ORDINAL", !0);
        a
            ?
            (this.appendValueInput("AT").setCheck("Number"), Blockly.Msg.ORDINAL_NUMBER_SUFFIX && this.appendDummyInput("ORDINAL").appendField(Blockly.Msg.ORDINAL_NUMBER_SUFFIX)) :
            this.appendDummyInput("AT");
...
Blockly.Blocks.lists_setIndex = {
  init: function() {
    ...
    this.setTooltip(function() {
      ...
      if ("FROM_START" == e || "FROM_END" == e)
        {d += "  " + Blockly.Msg.LISTS_INDEX_FROM_START_TOOLTIP.replace("%1", b.workspace.options.oneBasedIndex ?
                    "#1" :
                    "#0");}
      return d;
    });
...
Blockly.Blocks.lists_getSublist = {
  ...
  updateAt_: function(a, b) {
    ...
    this.removeInput("ORDINAL" + a, !0);
        b
            ?
            (this.appendValueInput("AT" + a).setCheck("Number"), Blockly.Msg.ORDINAL_NUMBER_SUFFIX && this.appendDummyInput("ORDINAL" + a).appendField(Blockly.Msg.ORDINAL_NUMBER_SUFFIX)) :
...
Blockly
    .Extensions
    .register("logic_op_tooltip", Blockly.Extensions.buildTooltipForDropdown("OP", Blockly.Constants.Logic.TOOLTIPS_BY_OP));
...
Blockly
    .Extensions
    .registerMutator("controls_if_mutator", Blockly.Constants.Logic.CONTROLS_IF_MUTATOR_MIXIN, null, ["controls_if_elseif", "controls_if_else"]);
...
Blockly
    .Extensions
    .register("controls_if_tooltip", Blockly.Constants.Logic.CONTROLS_IF_TOOLTIP_EXTENSION);
  ...
  onchange: function(a) {
    ...
    if ((b || c) && e)
      {for (var d = 0; 2 > d; d++) {
                ...
                f && !f
                    .outputConnection
                    .checkType_(e) && (Blockly.Events.setGroup(a.group), e === this.prevParentConnection_ ?
                        (this.unplug(), e.getSourceBlock().bumpNeighbours_()) :
                        (f.unplug(), f.bumpNeighbours_()), Blockly.Events.setGroup(!1))
            }}
...
Blockly
    .Extensions
    .registerMixin("logic_ternary", Blockly.Constants.Logic.LOGIC_TERNARY_ONCHANGE_MIXIN);
...
Blockly
    .Extensions
    .register("controls_whileUntil_tooltip", Blockly.Extensions.buildTooltipForDropdown("MODE", Blockly.Constants.Loops.WHILE_UNTIL_TOOLTIPS));
...
Blockly
    .Extensions
    .register("controls_flow_tooltip", Blockly.Extensions.buildTooltipForDropdown("FLOW", Blockly.Constants.Loops.BREAK_CONTINUE_TOOLTIPS));
...
Blockly
    .Extensions
    .registerMixin("contextMenu_newGetVariableBlock", Blockly.Constants.Loops.CUSTOM_CONTEXT_MENU_CREATE_VARIABLES_GET_MIXIN);
Blockly
    .Extensions
    .register("controls_for_tooltip", Blockly.Extensions.buildTooltipWithFieldText("%{BKY_CONTROLS_FOR_TOOLTIP}", "VAR"));
Blockly
    .Extensions
    .register("controls_forEach_tooltip", Blockly.Extensions.buildTooltipWithFieldText("%{BKY_CONTROLS_FOREACH_TOOLTIP}", "VAR"));
      ...
      do {
        ...
        b = b.getSurroundParent();
            ...
            a
                ...
                (this.setWarningText(Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING), this.isInFlyout || this.getInheritedDisabled() || this.setDisabled(!0));
    }
  }
};
Blockly
    .Extensions
    .registerMixin("controls_flow_in_loop_check", Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN);
Blockly.Blocks.math = {};
...
Blockly
    .Extensions
    .register("math_op_tooltip", Blockly.Extensions.buildTooltipForDropdown("OP", Blockly.Constants.Math.TOOLTIPS_BY_OP));
...
Blockly
    .Extensions
    .registerMutator("math_is_divisibleby_mutator", Blockly.Constants.Math.IS_DIVISIBLEBY_MUTATOR_MIXIN, Blockly.Constants.Math.IS_DIVISIBLE_MUTATOR_EXTENSION);
Blockly
    .Extensions
    .register("math_change_tooltip", Blockly.Extensions.buildTooltipWithFieldText("%{BKY_MATH_CHANGE_TOOLTIP}", "VAR"));
...
Blockly
    .Extensions
    .registerMutator("math_modes_of_list_mutator", Blockly.Constants.Math.LIST_MODES_MUTATOR_MIXIN, Blockly.Constants.Math.LIST_MODES_MUTATOR_EXTENSION);
...
Blockly.Blocks.procedures_defnoreturn = {
  ...
  setStatements_: function(a) {
    this.hasStatements_ !== a && (a ?
            (this.appendStatementInput("STACK").appendField(Blockly.Msg.PROCEDURES_DEFNORETURN_DO), this.getInput("RETURN") && this.moveInputBefore("STACK", "RETURN")) :
            this.removeInput("STACK", !0), this.hasStatements_ = a);
  },
  ...
  domToMutation: function(a) {
    ...
    for (var b = 0, c; c = a.childNodes[b]; b++)
      {if ("arg" == c.nodeName.toLowerCase()) {
                ...
                e = Blockly
                    .Variables
                    .getOrCreateVariablePackage(this.workspace, c, e, "");
                this
                    .argumentVarModels_
                    .push(e)
            }}
  ...
  decompose: function(a) {
    ...
    b.initSvg();
        this.getInput("RETURN") ?
            b.setFieldValue(this.hasStatements_ ?
                "TRUE" :
                "FALSE", "STATEMENTS") :
            b
  ...
  renameVarById: function(a, b) {
    ...
    if ("" == c.type) {
      c = c.name;
      for (var e = this.workspace.getVariableById(b), d = !1, f = 0; f < this.argumentVarModels_.length; f++)
        {this.argumentVarModels_[f].getId() == a && (this.arguments_[f] = e.name, this.argumentVarModels_[f] = e, d = !0);}
      d && this.displayRenamedVar_(c, e.name);
    }
  },
  ...
  customContextMenu: function(a) {
    if (!this.isInFlyout) {
      ...
      a.push(b);
      if (!this.isCollapsed())
        {for (d = 0; d < this.argumentVarModels_.length; d++)
                    b = {
                        enabled: !0
                    },
                    e = this.argumentVarModels_[d],
                    c = e.name,
                    b.text = Blockly
                    .Msg
                    .VARIABLES_SET_CREATE_GET
...
Blockly.Blocks.procedures_mutatorarg = {
  ...
  validator_: function(a) {
    var b = Blockly
        .Mutator
        .findParentWs(this.sourceBlock_.workspace);
    a = a
        .replace(/[\s\xa0]+/g, " ")
        .replace(/^ | $/g, "");
    if (!a)
    ...
    c || (c = b.createVariable(a, "")) && this.createdVariables_ && this
        .createdVariables_
        .push(c);
    return a;
  },
...
Blockly.Blocks.procedures_callnoreturn = {
  ...
  renameProcedure: function(a, b) {
    Blockly
        .Names
        .equals(a, this.getProcedureCall()) && (this.setFieldValue(b, "NAME"), this.setTooltip((this.outputConnection ?
    ...
    if (b)
      {if (a.join("\n") == this.arguments_.join("\n"))
                ...
                for (d = 0; d < this.arguments_.length; d++)
                    e = Blockly.Variables.getOrCreateVariablePackage(this.workspace, null, this.arguments_[d], ""),
                    this.argumentVarModels_.push(e);
                this.updateShape_();
                if (this.quarkIds_ = b)
                    for (d = 0; d < this.arguments_.length; d++)
                        e = this.quarkIds_[d],
                        e in this.quarkConnections_ && (f = this.quarkConnections_[e], Blockly.Mutator.reconnect(f, this, "ARG" + d) || delete this.quarkConnections_[e]);
  ...
  domToMutation: function(a) {
    ...
    b = [];
    for (var c = [], e = 0, d; d = a.childNodes[e]; e++)
    ...
    if (this.workspace && !this.workspace.isFlyout && a.recordUndo)
      {if (a.type == Blockly.Events.BLOCK_CREATE && -1 != a.ids.indexOf(this.id)) {
                ...
                if (!b) {
                    ...
                    b.setAttribute("x", c.x + Blockly.SNAP_RADIUS * (this.RTL ?
                        -1 :
                        1));
                    b.setAttribute("y", e);
                ...
                (b = this.getProcedureCall(), b = Blockly.Procedures.getDefinition(b, this.workspace), b || (Blockly.Events.setGroup(a.group), this.dispose(!0, !1), Blockly.Events.setGroup(!1))) :
                a.type == Blockly.Events.CHANGE && "disabled" == a.element && (b = this.getProcedureCall(), (b = Blockly.Procedures.getDefinition(b, this.workspace)) && b.id == a.blockId && ((b = Blockly.Events.getGroup()) && console.log("Saw an existing group while responding to a definition change"), Blockly.Events.setGroup(a.group), a.newValue ?
                    (this.previousDisabledState_ = this.disabled, this.setDisabled(!0)) :
                    this.setDisabled(this.previousDisabledState_), Blockly.Events.setGroup(b)))};
  },
  customContextMenu: function(a) {
    var b = {
      enabled: !0
        ...
        b = b.getSurroundParent();
            ...
            a
                ...
                ("procedures_defnoreturn" == b.type && this.hasReturnValue_ ?
                    ...
                    "procedures_defreturn" != b.type || this.hasReturnValue_ || (this.removeInput("VALUE"), this.appendValueInput("VALUE").appendField(Blockly.Msg.PROCEDURES_DEFRETURN_RETURN), this.hasReturnValue_ = !0), this.setWarningText(null), this.isInFlyout || this.setDisabled(!1)) :
                (this.setWarningText(Blockly.Msg.PROCEDURES_IFRETURN_WARNING), this.isInFlyout || this.getInheritedDisabled() || this.setDisabled(!0));
    }
  },
...
Blockly.Constants.Text.QUOTE_IMAGE_MIXIN = {
  QUOTE_IMAGE_LEFT_DATAURI: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAKCAQAAAAqJXdxAAAAn0lEQVQI1z" +
        "3OMa5BURSF4f/cQhAKjUQhuQmFNwGJEUi0RKN5rU7FHKhpjEH3TEMtkdBSCY1EIv8r7nFX9e29V7EBAO" +
        "vu7RPjwmWGH/VuF8CyN9/OAdvqIXYLvtRaNjx9mMTDyo+NjAN1HNcl9ZQ5oQMM3dgDUqDo1l8DzvwmtZ" +
        "N7mnD+PkmLa+4mhrxVA9fRowBWmVBhFy5gYEjKMfz9AylsaRRgGzvZAAAAAElFTkSuQmCC",
  QUOTE_IMAGE_RIGHT_DATAURI: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAKCAQAAAAqJXdxAAAAqUlEQVQI1z" +
        "3KvUpCcRiA8ef9E4JNHhI0aFEacm1o0BsI0Slx8wa8gLauoDnoBhq7DcfWhggONDmJJgqCPA7neJ7p93" +
        "4EOOKOnM8Q7PDElo/4x4lFb2DmuUjcUzS3URnGib9qaPNbuXvBO3sGPHJDRG6fGVdMSeWDP2q99FQdFr" +
        "z26Gu5Tq7dFMzUvbXy8KXeAj57cOklgA+u1B5AoslLtGIHQMaCVnwDnADZIFIrXsoXrgAAAABJRU5Erk" +
        "Jggg==",
  ...
  newQuote_: function(a) {
    ...
    return new Blockly.FieldImage(a ?
            ...
            this.QUOTE_IMAGE_RIGHT_DATAURI, this.QUOTE_IMAGE_WIDTH, this.QUOTE_IMAGE_HEIGHT, a ?
            "\u201c" :
            "\u201d");
  }
};
...
Blockly
    .Extensions
    .register("text_append_tooltip", Blockly.Extensions.buildTooltipWithFieldText("%{BKY_TEXT_APPEND_TOOLTIP}", "VAR"));
Blockly.Constants.Text.TEXT_INDEXOF_TOOLTIP_EXTENSION = function() {
  ...
  this.setTooltip(function() {
    return Blockly
        ...
        .replace("%1", a.workspace.options.oneBasedIndex ?
                "0" :
                "-1");
  });
};
...
Blockly.Constants.Text.TEXT_CHARAT_EXTENSION = function() {
  ...
  this.setTooltip(function() {
    ...
    ("FROM_START" == b || "FROM_END" == b) && (b = "FROM_START" == b ?
            Blockly.Msg.LISTS_INDEX_FROM_START_TOOLTIP :
...
Blockly
    .Extensions
    .register("text_indexOf_tooltip", Blockly.Constants.Text.TEXT_INDEXOF_TOOLTIP_EXTENSION);
Blockly
    .Extensions
    .register("text_quotes", Blockly.Constants.Text.TEXT_QUOTES_EXTENSION);
Blockly
    .Extensions
    .registerMutator("text_join_mutator", Blockly.Constants.Text.TEXT_JOIN_MUTATOR_MIXIN, Blockly.Constants.Text.TEXT_JOIN_EXTENSION);
Blockly
    .Extensions
    .registerMutator("text_charAt_mutator", Blockly.Constants.Text.TEXT_CHARAT_MUTATOR_MIXIN, Blockly.Constants.Text.TEXT_CHARAT_EXTENSION);
...
Blockly.Constants.Variables.CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN = {
  customContextMenu: function(a) {
    if (!this.isInFlyout) {
      ...
      d = document.createElement("block");
...
Blockly
    .Extensions
    .registerMixin("contextMenu_variableSetterGetter", Blockly.Constants.Variables.CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN);
...
Blockly.Blocks['pin_mode'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("모드")
        .appendField(new Blockly.FieldDropdown([["읽기","INPUT"], ["쓰기","OUTPUT"]]), "MODE");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(60);
    this.setTooltip("");
...
Blockly
    .Extensions
    .registerMixin("contextMenu_variableDynamicSetterGetter", Blockly.Constants.VariablesDynamic.CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN);
